const CACHE_NAME="clickset-official-1.0.4";
const APP_SHELL=["./","./index.html","./clickset-1.0.4.css","./clickset-1.0.4.js","./manifest.webmanifest","./cover.png","./click.wav","./logo-4l.jpg","./logo-h80.jpeg","./logo-tocipam.jpg","./logo-pgs.png","./logo-clickset.png"];
