const CACHE="clickset-v0195";
const APP_SHELL=["./","./index.html","./styles.css?v=0195","./app.js?v=0195","./manifest.webmanifest","./cover.png","./click.wav?v=0195","./logo-4l.jpg","./logo-h80.jpeg","./logo-tocipam.jpg","./logo-pgs.png","./logo-clickset.png"];
